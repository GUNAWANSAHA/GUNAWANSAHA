...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6285706819052@s.whatsapp.net`]
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nW a a n. (@It's Me Wan!) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
*「 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦Wan シ︎ 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦Wanシ︎', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Terimakasih Telah Terdaftar Di S A D B O T*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`Hai ${pushname}\n ${ucapanWaktu} Kak 👋`
               ...
               buttonText:{displayText: 'Allmenuシ︎'},type:1},
               {buttonId:`${prefix}owner`,buttonText:{displayText:'Creatorシ︎'},type:1},
               {buttonId:`${prefix}command`,buttonText:{displayText:'Simple menuシ︎'},type:1}]
...
case 'bugreport':
              ...
              itsmevall.sendMessage('6285706819052@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://instagram.com/wan_syyy')
break
 ...
 rows: [
                          {
                           ...
                           {
                              "title": "Testing kack @Genzo Gayy",
                              "rowId": ""
                           },
                           {
                              "title": "follow ig owner @wan_syy",
                              "rowId": ""
                           },
                           {
                              "title": "UpswMenu",
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦W𝘢n シ︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
㋛${prefix}upswlokasi
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔??W𝘢n シ︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
case 'katalog':
    ...
    "listMessage": {
      ...
      "footerText": " 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦Wan シ︎"
    }
  }, {quoted: freply})
...
case 'script':
		case 'sc':
		case 'sourcecode':
		itsmevall.sendMessage(from, { text: "https://github.com/MyWanz", matchedText: 'nopee', description: "", title: "Ngapain Om?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
break
      case "jadibot":
        if (!mek.key.fromMe) return reply("MAAF KAK MASIH DALAM PEMELIHARAAN");
...
buttons = [{buttonId: `${prefix}listnulis`,buttonText:{displayText: `List Nulis🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦W𝘢n シ︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @wan_syy ☹︎`,buttons,headerType:4}
...
sendButMessage(from, tiyo, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦W𝘢n シ︎`, [
            {              
...
itsmevall.sendMessage(_.jid, 
			...
			"footerText": '𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦W𝘢n シ︎',
			"buttons": [
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦Wan シ︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @wan_syy ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘐𝘵𝘴𝘔𝘦Wan シ︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄?? @_𝙞??𝙨𝙢𝙚Wan☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
case 'bj':
